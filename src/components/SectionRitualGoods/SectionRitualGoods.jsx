    ...
    <section className={s.sectionRitualGoods}>
      <div className="container">
        <div className={s.ritualGoods__container}>
          ...
          <p className={s.ritualGoodsDiscription}>Продажем ритуальних товарів та приладдя наша компанія займається вже понад 15 років. Все ритуальне приладдя, яке ми маємо в наявності, ви можете подивитися відвідавши нас.</p>
